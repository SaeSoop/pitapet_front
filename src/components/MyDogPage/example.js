...
// };
    ...
    const handleChange = (e) => {
        const { email, password, phone, nickname, gender, birth, agreeUse, agreePriv } = e.target;
        setFormData({ "email": email, "password":password, "phone":phone, "nickname":nickname, "gender":gender, "birth":birth, "agreeUse":agreeUse, "agreePriv":agreePriv});
    };
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post('https://43.202.64.233:3000/api/user/join', formData, { timeout: 5000 });
    ...
    return (
        <form onSubmit={handleSubmit}>    
            ...
            <div class="form-group email-line">
                ...
                <input type="email" id="email" placeholder="이메일을 입력해주세요." onChange={handleChange}/>
            ...
            <div class="form-group password-line">
                ...
                <input type="password" id="password" placeholder='비밀번호를 입력해주세요.' onChange={handleChange}/>
            </div>
            <div class="form-group passwordck-line">
                <label for="su3">비밀번호 확인</label>
                <input type="password" id="passwordck" placeholder='비밀번호를 다시 입력해주세요.' onChange={handleChange}/>
            </div>
            <div class="form-group phone-line">
                <label for="su4">휴대전화</label>
                <input type="text" id="phone" placeholder='숫자만 입력해주세요.' onChange={handleChange}/>
            ...
            <div class="form-group nickname-line">
                ...
                <input type="text" id="nickname" placeholder='이름을 입력해주세요.' onChange={handleChange}/>
            </div>
            ...
            <div class="form-group birth-line">
                ...
                <input type="text" id="birth" placeholder='생년월일 8자리를 입력해주세요.' onChange={handleChange}/>
            </div>
            <hr />
