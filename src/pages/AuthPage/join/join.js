...
import { Input, Agree, handleSubmit } from '../../../components/Authpage/join';
...
function Join() {
    ...
    return (
        <form className='form-horizontal' onSubmit={(event) => {
            ...
            <Input title="휴대전화" type="text" id="phone" placehodler="숫자만 입력하세요" formData={formData} setFormData={setFormData} ></Input>
            <Input title="닉네임" type="text" id="nickname" placehodler="이름을 입력하세요" formData={formData} setFormData={setFormData} ></Input>
            <Input mode="gender" formData={formData} setFormData={setFormData} ></Input>
            ...
            {/* 회원가입 버튼 */}
            <Button type="submit" className="signBtn" onClick={(event)=>{
